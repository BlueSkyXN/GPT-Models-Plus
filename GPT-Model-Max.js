...
(() => {
    ...
    const models = [
      ...
      { value: 'gpt-3.5-turbo', label: 'gpt-3.5-turbo*HACK' },
      { value: 'text-davinci-003', label: 'text-davinci-003*HACK' },
      { value: 'code-davinci-002', label: 'code-davinci-002*HACK' },
      { value: 'gpt-4-32k', label: 'gpt-4-32k*HACK' },
    ]
